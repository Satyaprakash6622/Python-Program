...
if __name__ == '__main__':
	...
	while(condition):
		...
		print("\nThe entered information is -\nName: {}\nAge: {}\nContact Number: {}\nEmail ID: {}"
			.format(student_inbo_list[0], student_info_list[1], student_info_list[2], student_info_list[3]))
		
		choice_check = input("Is the entered information correct? (yes/no): ")

		if choice_check =="yes":
			write_into_csv(student_info_list)
			condition_check = input("Enter (yes/no) if yoy want to enter information for another students: ")
